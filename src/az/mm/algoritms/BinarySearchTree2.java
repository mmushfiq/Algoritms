...
public class BinarySearchTree2 {
    ...
    private static int[] bst = {25, 15, 50, 10, 22, 35, 70, 4, 12, 18, 24, 31, 44, 66, 90};
    /*
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        int root = 0; // 0 deyil, 1 olacaq chunki root deyerimiz 1-ci indeksden bashlayir
    ...
    private int left(int i)  { return 2*(i+1)-1; }    // 2*(i+1)-1
    private int right(int i) { return 2*(i+1); }  // 2*(i+1)
